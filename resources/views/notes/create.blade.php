...
@section('content')
    <div class="container pt-5">
        ...
        <form id="create-note-form" action="{{ route('notes.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12 mb-3">
                ...
                <div>
                    <textarea id="editor" name="content" placeholder="Start your note..."></textarea>
            ...
            <div class="col-md-12 mb-3">
                <button class="btn btn-primary "> <i class="bi bi-box-arrow-down" style="vertical-align: middle;"></i>
                    Save Note</button>
            </div>
